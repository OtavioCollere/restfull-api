...
class CreateCostumerService {
    public async execute({
        ...
        alergia, gestante_lactante, intoleranciaLactose, diabetes, roacutam, obs, tratamento
        ...
        const cpfExists = await costumerRepository.findByCpf(cpf);
